...
// MARK: - Copy (Let Him Cook · Taiwan · March 28, 2026)
...
private extension LegalDocumentKind {
    ...
    1. The service
    The App helps you save, organize, and edit recipes and related content, including by processing links you submit. Features may change; we may modify, suspend, or discontinue any part of the App where permitted by law.
    ...
    The App may rely on service providers (e.g. authentication, cloud infrastructure, subscription status, analytics). Their processing is described in our Privacy & AI Policy and subject to their respective terms.
    ...
    We use information to: provide and improve the App; authenticate users; process URLs and content you submit; enforce usage limits and prevent abuse; deliver subscription features; communicate about the service (e.g. support); comply with law; and protect rights and safety.
    ...
    **Retention:** We retain data only as long as needed to provide the App, comply with law, resolve disputes, and enforce our agreements. Specific retention may depend on the feature (e.g. cached media or analysis).
    ...
    • AI or cloud providers that process content you submit to return recipe results.
